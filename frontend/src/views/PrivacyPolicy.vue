      ...
      <div class="mt-6 flex justify-center overflow-y-auto">
        <div class="w-full max-w-4xl prose prose-lg">
          ...
          <p>
            ...
            verwendete Funktionen eines Onlineangebots zu speichern. Cookies können ferner in Bezug
          ...
          <p>
            ...
            also auch von Cookies, unbedingt erforderlich sind, um den Nutzern einen von ihnen
